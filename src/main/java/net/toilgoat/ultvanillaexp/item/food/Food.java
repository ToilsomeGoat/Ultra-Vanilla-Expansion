...
public class Food {
    ...
    public static final FoodProperties PEANUT = new FoodProperties.Builder().nutrition(3).saturationModifier(0.3f).build();
    ...
    public static final FoodProperties MELTED_COCOA = new FoodProperties.Builder().nutrition(1).saturationModifier(0.3F).build();
    public static final FoodProperties CHOCOLATE_PIECE = new FoodProperties.Builder().nutrition(2).saturationModifier(0.3F).build();
    public static final FoodProperties DARK_CHOCOLATE = new FoodProperties.Builder().nutrition(8).saturationModifier(0.8f).build();
    public static final FoodProperties MILK_CHOCOLATE = new FoodProperties.Builder().nutrition(6).saturationModifier(0.8f).build();
